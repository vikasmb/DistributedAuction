...
public class AuctionServer {
	...
	private void getBid(BasicDBObject remoteBidder,
		...
		String remoteAddress = remoteBidder
				.getString(SellerDetails.FIELD_REMOTE);// get remote address
		String sellerName = remoteBidder.getString(SellerDetails.FIELD_NAME);// get
																				// the
																				// seller's
																				// name
